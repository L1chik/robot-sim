...
pub fn robot_init(window: &mut Window) -> Robot {
    ...
    let mut lower_arm_model =
        shoulder_model.add_obj(parts.lower_arm_obj, parts.lower_arm_mtl, scale);
    ...
    let wrist_model = upper_arm_model.add_obj(parts.wrist_obj, parts.wrist_mtl, scale);
    ...
    shoulder
        .node
        .set_local_translation(Translation3::new(0.0, 0.0, 0.0));
    lower_arm
        .node
        .set_local_translation(Translation3::new(0.0, 0.8, 0.25));
    elbow
        .node
        .set_local_translation(Translation3::new(0.0, 0.73, -1.47));
    upper_arm
        .node
        .set_local_translation(Translation3::new(0.0, 0.9, 1.85));
    wrist
        .node
        .set_local_translation(Translation3::new(0.0, -0.1, 0.32));
